...
//   <div class="group">
//   <input id="ingredients[${ingredientCount}][name]" type="text" name="ingredients[${ingredientCount}][name] wire:model="ingredients.${ingredientCount}" wire:change="updateIngredients"" required>
//   <span class="highlight"></span>
//   <span class="bar"></span>
//   <label for="ingredients[${ingredientCount}][name]">Ingredient</label>
//   </div>
//   <div class="group">
//   <input id="ingredients[${ingredientCount}][mass]" type="text" name="ingredients[${ingredientCount}][mass]" required>
//   <span class="highlight"></span>
//   <span class="bar"></span>
...
//   const event = new CustomEvent('new-ingredient-added');
...
// Parallax start
$('.parallax_w').parallax({
  imageSrc:'/assets/images/kitchen.jpg',
});
// Parallax end
...
const descLabel = document.querySelector('.descLabel');

function checkTextarea() {
  if (descriptionTextarea.value !== '' || descriptionTextarea === document.activeElement) {
    descLabel.classList.add('focused');
  } else {
    descLabel.classList.remove('focused');
  }
}

descriptionTextarea.addEventListener('input', checkTextarea);
descriptionTextarea.addEventListener('focus', checkTextarea);
descriptionTextarea.addEventListener('blur', checkTextarea);
